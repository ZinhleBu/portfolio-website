...
export const ProjectDescription = ({ initialData, projectId }: ProjectDescriptionProps) => {
  ...
  const handlePromtGeneration = async () => {
    try {
      setIsPrompting(true);
      const customPrompt = `Could you please draft a project description document for the project of ${rolename}? The project description should include roles & responsibilities, key features, and details about the project.  Additionally, you can list any optional skill related to project. Thanks!`;
      await getGenerativeAIResponse(customPrompt).then((data) => {
        ...
        toast.success("Project requirements generated");
      });
    } catch (error) {
      console.log(error);
      toast.error("Something went wrong...");
