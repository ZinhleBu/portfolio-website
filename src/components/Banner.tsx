...
const bannerVariants = cva("border text-center p-4 text-sm items-center w-full rounded-md shadow-md", {
    variants: {
        variant: {
...
export const Banner = ({variant, label}: BannerProps) => {
  ...
  return (
    <div className={cn(bannerVariants({variant}), "flex justify-start")}>
